        ...
        <transition name="fade">
            ...
            <div v-if="currentArticle" class="flex flex-row  p-1">
                <section class="w-4/5 container relative text-sm" v-if="currentArticle">
                    ...
                    <input type="text" class="w-full text-2xl" v-model="currentArticle.title" @change="currentArticle.slug=$slugify(currentArticle.title)"/>
                    <label>Slug </label>
                    <input type="text" class="w-full text-2xl" v-model="currentArticle.slug" @blur="$slugify(currentArticle.title)"/>
                    <label>Excerpt</label>
