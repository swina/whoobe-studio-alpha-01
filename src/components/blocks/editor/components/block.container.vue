<template>
    <div 
        ...
        :class="classe(doc.css)" :style="doc.style + ' ' +  background(doc)" @dblclick="doc.blocks.length===0?$action('block_add_element'):null" :title="doc.type" :data-container-tag="doc.type">
